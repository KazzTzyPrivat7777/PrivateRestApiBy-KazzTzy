...
/**
 * Enhanced response wrapper that adds copy feature for successful requests
 * 
...
export function apiResponse(res: Response, success: boolean, data: any, message?: string): Response {
    ...
    if (success) {
        ...
        // Add copy feature for successful requests
...
/**
 * Generate copy command based on data type
 * 
